...
import com.delirium.finapp.tools.PortBinding;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("!!! Failed to start finapp: " + e.getMessage());
            System.err.println("!!! Please send log files (finapp.log) to style.daniel@gmail.com");
        }
    }
    ...
    public void initApplication() throws IOException {
        ...
        if (!PortBinding.available(port)) {
            ...
            throw new FinappLoadingException("Port unavailable, exiting");
        }
