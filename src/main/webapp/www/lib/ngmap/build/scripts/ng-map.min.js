angular.module("ngMap", []), function () {
    ...
    var SPECIAL_CHARS_REGEXP = /([\:\-\_]+(.))/g, MOZ_HACK_REGEXP = /^moz([A-Z])/, Attr2Options = function ($parse, $timeout, NavigatorGeolocation, GeoCoder) {
        var orgAttributes = function (e) {
            ...
            var n = {}, o = function (e) {
                ...
                var n = t.match(/([^\(]+)\(([^\)]*)\)/), o = n[1], r = n[2].replace(/event[ ,]*/, ""), i = $parse("[" + r + "]");
                return function (t) {
                    function n(e, t) {
                        return e[t]
                    }

                    var r = i(e), a = o.split(".").reduce(n, e);
    ...
    angular.module("ngMap").directive("bicyclingLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("bicyclingLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("bicyclingLayers", p)
                })
            }
        }
    }])
    ...
    angular.module("ngMap").directive("cloudLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("cloudLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("cloudLayers", p)
                })
            }
        }
    }])
    ...
    angular.module("ngMap").directive("customControl", ["Attr2Options", "$compile", function (e, t) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = (n.orgAttributes(o), n.filter(r)), s = n.getOptions(a, e), c = n.getEvents(e, a), u = o[0].parentElement.removeChild(o[0]);
                t(u.innerHTML.trim())(e);
                for (var p in c)google.maps.event.addDomListener(u, p, c[p]);
    ...
    var e = function (e, t) {
        ...
        var o = t, r = new google.maps.DirectionsService, i = function (e, t) {
            ...
            o.waypoints && ("[]" == o.waypoints || "" == o.waypoints) && delete o.waypoints, o.origin && o.destination && r.route(o, function (t, o) {
                o == google.maps.DirectionsStatus.OK && n(function () {
                    e.setDirections(t)
                })
            })
        }, a = function (t, n, r, a) {
            var s = o.orgAttributes(n), c = o.filter(r), u = o.getOptions(c), p = o.getEvents(t, c), l = o.getAttrsToObserve(s), g = e(u, p);
    ...
    angular.module("ngMap").directive("drawingManager", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, n, o, r) {
                var i = (t.orgAttributes(n), t.filter(o)), a = t.getOptions(i), s = t.getControlOptions(i), c = t.getEvents(e, i), u = new google.maps.drawing.DrawingManager({
                ...
                for (var p in c)google.maps.event.addListener(u, p, c[p]);
    ...
    angular.module("ngMap").directive("dynamicMapsEngineLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.filter(r), s = t.getOptions(a), c = t.getEvents(e, a, c), u = n(s, c);
    ...
    var e = function (e, t, n, o) {
        var r = e, i = function (e, o, r) {
            ...
            t.css("display", "none");
            var s, c = r.orgAttributes(t), u = r.filter(n), p = r.getOptions(u, e), l = r.getEvents(e, u);
            !p.position || p.position instanceof google.maps.LatLng || (s = p.position);
            var g = i(p, l, t);
    ...
    angular.module("ngMap").directive("kmlLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("kmlLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("kmlLayers", p)
                })
            }
        }
    }])
    ...
    var e, t, n, o, r = function (n, r, i) {
        ...
        return !t.mapLazyLoad && void 0, o = e.html(), n = t.mapLazyLoad, document.querySelector('script[src="' + n + (n.indexOf("?") > -1 ? "&" : "?") + 'callback=lazyLoadCallback"]') ? !1 : (e.html(""), {pre: r})
    }, a = function (n, o) {
    ...
    var t = function (t, n, o) {
        var r = t, i = function (t, i, a, s) {
            ...
            var p = function (e, r) {
                ...
                var p = e.center;
                p ? p instanceof google.maps.LatLng || (delete e.center, s.getGeoLocation(p).then(function (e) {
                    i.setCenter(e);
                    var n = a.geoCallback;
                    n && o(n)(t)
                }, function () {
                ...
                s.observeAttrSetObj(c, a, i), s.map = i, s.addObjects(s._objects), t.map = i, t.map.scope = t, google.maps.event.addListenerOnce(i, "idle", function () {
                    t.$emit("mapInitialized", i), a.zoomToIncludeMarkers && (s.zoomToIncludeMarkers(), "auto" == a.zoomToIncludeMarkers && t.$on("objectChanged", function (e, t) {
                        "markers" == t[0] && s.zoomToIncludeMarkers()
                    }))
                })
            }, l = r.filter(a), g = r.getOptions(l, t), d = r.getControlOptions(l), f = angular.extend(g, d), m = r.getEvents(t, l);
    ...
    var e = function (e, t, n, o, r) {
        var i = r, a = this, s = function (e, t, n) {
            e.$observe(t, function (e) {
                if (e) {
                    var o = i.camelCase("set-" + t), r = i.toOptionValue(e, {key: t});
    ...
    var e = function (e, t) {
        ...
        var o = t, r = function (t, r, i, a) {
            var s, c = o.orgAttributes(r), u = o.filter(i), p = o.getOptions(u, t), l = o.getEvents(t, u);
            p.position instanceof google.maps.LatLng || (s = p.position);
            var g = e(p, l);
            a.addObject("markers", g), s && a.getGeoLocation(s).then(function (e) {
                g.setPosition(e), p.centered && g.map.setCenter(e);
                var o = i.geoCallback;
                o && n(o)(t)
    ...
    var e = function (e, t) {
        var n = e, o = function (e, o, r, i) {
            var a = n.filter(r), s = n.getOptions(a), c = n.getEvents(e, a), u = new google.maps.places.Autocomplete(o[0], s);
            for (var p in c)google.maps.event.addListener(u, p, c[p]);
            var l = function () {
                t(function () {
            ...
            google.maps.event.addListener(u, "place_changed", l), o[0].addEventListener("change", l), r.$observe("types", function (e) {
                if (e) {
    ...
    var e = function (e) {
        ...
        for (var p in n)n[p] && google.maps.event.addListener(o, p, n[p]);
        return o
    }, n = function (e, n) {
        var o = e, r = function (e, r, i, a) {
            var s, c, u = o.orgAttributes(r), p = o.filter(i), l = o.getOptions(p), g = o.getEvents(e, p);
    ...
    var e = function (e) {
        var t = e, n = function (e, t, n) {
            ...
            var i = (t.orgAttributes(o), t.filter(r)), a = t.getOptions(i), s = t.getControlOptions(i), c = angular.extend(a, s), u = t.getEvents(e, i);
            e.$on("mapInitialized", function (e, t) {
                var o = n(t, c, u);
    ...
    angular.module("ngMap").directive("trafficLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("trafficLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("trafficLayers", p)
                })
            }
        }
    }])
    ...
    angular.module("ngMap").directive("transitLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("transitLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("transitLayers", p)
                })
            }
        }
    }])
    ...
    angular.module("ngMap").directive("weatherLayer", ["Attr2Options", function (e) {
        ...
        return {
            restrict: "E", require: "^map", link: function (e, o, r, i) {
                var a = t.orgAttributes(o), s = t.filter(r), c = t.getOptions(s), u = t.getEvents(e, s), p = n(c, u);
                i.addObject("weatherLayers", p), i.observeAttrSetObj(a, r, p), o.bind("$destroy", function () {
                    i.deleteObject("weatherLayers", p)
                })
            }
        }
    }])
