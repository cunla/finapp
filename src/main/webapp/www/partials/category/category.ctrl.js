(function () {
    angular.module('app.controllers')
        .controller('catCtrl', ['$scope', 'FinApp', '$stateParams', '$rootScope', '$ionicPopup', 'DatePicker', catCtrl])
    function catCtrl($scope, FinApp, $stateParams, $rootScope, $ionicPopup, DatePicker) {
