appCtrllers
    .controller('homeCtrl', ['$scope', 'FinApp', '$state', '$stateParams', '$rootScope','$ionicPopup',
        function ($scope, Finance, $state, $stateParams, $rootScope, $ionicPopup) {
            $scope.t={};
            $scope.doRefresh=function(){
                Finance.getTransactions().then(function(results){
            ...
            $scope.createTransaction=function(t){
                Finance.newTransaction((t.plusSign ? t.amount: -t.amount)).then(function(res){
            ...
            $scope.deleteTransaction=function(t){
                ...
                confirmPopup.then(function(res) {
                     if(res) {
                        ...
                        Finance.deleteTransaction(t.objectId).then(function(){
